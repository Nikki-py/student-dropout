...
1. Data loading & cleaning — reads dataset.csv, fixes column name formatting, encodes the target variable, and drops missing values.
2. Exploratory analysis — visualizes the dropout distribution and the top features correlated with dropout.
3. Preprocessing — splits data into train/test sets (80/20) and standardizes features with StandardScaler.
4. Model training — trains two classifiers:
   - Logistic Regression (class_weight='balanced')
   - Support Vector Machine (class_weight='balanced')
5. Evaluation — reports accuracy, classification reports, and confusion matrices for both models, and compares them with an ROC curve / AUC score.
6. Feature importance — plots the top features influencing dropout based on logistic regression coefficients.
...
3. Add your dataset.csv file to the project root.
4. Open Student_Dropout_Stats.ipynb in Jupyter or Google Colab and run all cells.
